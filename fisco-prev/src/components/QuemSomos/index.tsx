  ...
  return (
    <section className='my-36 w-full px-6'>
      ...
      <div className='w-full px-6 py-8 flex flex-wrap bg-cardServicosBg'>
        ...
        <p className='content text-cinzaSubTitle mb-6'>Empreendedores, eles acreditavam que através dessa empresa garantiriam uma vida melhor para sua família e para todas as pessoas que estivessem verdadeiramente envolvidas. E como eles estavam certos! Ao longo destes anos, a Organização Fisco Previ cresceu e se profissionalizou, tornando-se uma das empresas de Prestação de Serviços de Contabilidade, Fiscal e Departamento Pessoal mais respeitadas do ramo em nossa cidade.</p>
